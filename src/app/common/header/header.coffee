...
.controller("BasicHeaderCtrl", ($scope, $state, $rootScope, UserNotificationSettingsModal, UserSettingsDialog, currentUser, AboutDoubtfireModal, $transitions, $document, $filter) ->
